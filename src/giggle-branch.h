...
GiggleBranch          * giggle_branch_new               (const gchar    *name);

G_CONST_RETURN gchar  * giggle_branch_get_name          (GiggleBranch   *branch);
GiggleRevision        * giggle_branch_get_head_revision (GiggleBranch   *branch);
